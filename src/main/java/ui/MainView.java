...
public class MainView extends Application{
    ...
    public MainView(DBConnector connector) throws URISyntaxException, IOException, InterruptedException {
        this.connector = connector;
        this.username = connector.me();
    }
    ...
    public void initialize() throws URISyntaxException, IOException, InterruptedException {
        ...
        observableList.add(connector.newEvent("temp", "temp", "2024-06-20 20:00:00"));
